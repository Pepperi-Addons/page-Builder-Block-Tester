(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@pepperi-addons/ngx-lib/icon', ['exports', '@angular/core', '@angular/common', '@pepperi-addons/ngx-lib'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['pepperi-addons'] = global['pepperi-addons'] || {}, global['pepperi-addons']['ngx-lib'] = global['pepperi-addons']['ngx-lib'] || {}, global['pepperi-addons']['ngx-lib'].icon = {}), global.ng.core, global.ng.common, global['pepperi-addons']['ngx-lib']));
}(this, (function (exports, i0, common, ngxLib) { 'use strict';
    ...
    var allIcons = {
        arrow_back_left: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19.713 4.309c.383.412.383 1.08 0 1.491l-3.916 5.454a1.113 1.113 0 000 1.492l3.916 5.454c.383.412.383 1.08 0 1.491a.93.93 0 01-1.384 0l-5.756-6.2c-.764-.823-.764-2.159 0-2.982l5.756-6.2a.93.93 0 011.384 0zm-7 0c.383.412.383 1.08 0 1.491l-3.916 5.454a1.113 1.113 0 000 1.492l3.916 5.454c.383.412.383 1.08 0 1.491a.93.93 0 01-1.384 0l-5.756-6.2c-.764-.823-.764-2.159 0-2.982l5.756-6.2a.93.93 0 011.384 0z" fill-rule="evenodd"/></svg>',
        arrow_back_right: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M4.287 4.309a1.113 1.113 0 000 1.491l3.916 5.454c.382.412.382 1.08 0 1.492L4.287 18.2a1.113 1.113 0 000 1.491.93.93 0 001.384 0l5.756-6.2c.764-.823.764-2.159 0-2.982l-5.756-6.2a.93.93 0 00-1.384 0zm7 0a1.113 1.113 0 000 1.491l3.916 5.454c.382.412.382 1.08 0 1.492L11.287 18.2a1.113 1.113 0 000 1.491.93.93 0 001.384 0l5.756-6.2c.764-.823.764-2.159 0-2.982l-5.756-6.2a.93.93 0 00-1.384 0z" fill-rule="evenodd"/></svg>',
        arrow_back: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M19.713 4.309c.383.412.383 1.08 0 1.491l-3.916 5.454a1.113 1.113 0 000 1.492l3.916 5.454c.383.412.383 1.08 0 1.491a.93.93 0 01-1.384 0l-5.756-6.2c-.764-.823-.764-2.159 0-2.982l5.756-6.2a.93.93 0 011.384 0zm-7 0c.383.412.383 1.08 0 1.491l-3.916 5.454a1.113 1.113 0 000 1.492l3.916 5.454c.383.412.383 1.08 0 1.491a.93.93 0 01-1.384 0l-5.756-6.2c-.764-.823-.764-2.159 0-2.982l5.756-6.2a.93.93 0 011.384 0z"/></svg>',
        arrow_down_alt: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M11.933 20a2 2 0 01-.059-.004L12 20a2.026 2.026 0 01-.527-.07l-.029-.009a1.476 1.476 0 01-.121-.039l-.01-.004a2.006 2.006 0 01-.405-.202l-.017-.012-6-4a2 2 0 012.218-3.328L10 14.263 10 6a2 2 0 114 0v8.263l2.89-1.927a2 2 0 012.22 3.328l-6 4-.012.008c-.124.081-.257.15-.398.202l-.012.004-.11.037a1.984 1.984 0 01-.025.008l-.011.002a1.315 1.315 0 01-.124.031l-.026.005a1.194 1.194 0 01-.131.022c-.007 0-.014.002-.02.003l-.02.002a1.995 1.995 0 01-.053.005l-.044.003a1.789 1.789 0 01-.057.003z"/></svg>',
        arrow_down: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M5.8 9.287l5.454 3.916c.412.382 1.08.382 1.492 0L18.2 9.287a1.113 1.113 0 011.491 0 .93.93 0 010 1.384l-6.2 5.756c-.823.764-2.159.764-2.982 0l-6.2-5.756a.93.93 0 010-1.384 1.113 1.113 0 011.491 0z"/></svg>',
        arrow_either: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M7.35 14.215l4.09 2.937a.835.835 0 001.12 0l4.09-2.937a.835.835 0 011.118 0 .698.698 0 010 1.038l-4.65 4.317a1.67 1.67 0 01-2.237 0l-4.65-4.317a.698.698 0 010-1.038.835.835 0 011.12 0zM13.12 4.43l4.65 4.317a.698.698 0 010 1.038.835.835 0 01-1.12 0l-4.09-2.937a.835.835 0 00-1.118 0L7.35 9.785a.835.835 0 01-1.12 0 .698.698 0 010-1.038l4.65-4.317a1.67 1.67 0 012.238 0z"/></svg>',
        arrow_left_alt: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M4 11.933a2 2 0 01.004-.059L4 12a2.026 2.026 0 01.07-.527l.009-.029a1.476 1.476 0 01.039-.121l.004-.01a2.006 2.006 0 01.202-.405l.012-.017 4-6a2 2 0 013.328 2.218L9.737 10 18 10a2 2 0 110 4H9.737l1.927 2.89a2 2 0 01-3.328 2.22l-4-6-.008-.012a1.993 1.993 0 01-.202-.398l-.004-.012-.037-.11a1.984 1.984 0 01-.008-.025l-.002-.011a1.315 1.315 0 01-.031-.124l-.005-.026a1.194 1.194 0 01-.022-.131c0-.007-.002-.014-.003-.02l-.002-.02a1.995 1.995 0 01-.005-.053l-.003-.044A1.789 1.789 0 014 12.067z"/></svg>',
        arrow_left: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M14.713 5.8l-3.916 5.454a1.113 1.113 0 000 1.492l3.916 5.454c.383.412.383 1.08 0 1.491a.93.93 0 01-1.384 0l-5.756-6.2c-.764-.823-.764-2.159 0-2.982l5.756-6.2a.93.93 0 011.384 0c.383.412.383 1.08 0 1.491z"/></svg>',
        arrow_right_alt: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M20 11.933a2 2 0 00-.004-.059L20 12a2.026 2.026 0 00-.07-.527l-.009-.029a1.476 1.476 0 00-.039-.121l-.004-.01a2.006 2.006 0 00-.202-.405l-.012-.017-4-6a2 2 0 00-3.328 2.218L14.263 10 6 10a2 2 0 100 4h8.263l-1.927 2.89a2 2 0 003.328 2.22l4-6 .008-.012c.081-.124.15-.257.202-.398l.004-.012.037-.11.008-.025.002-.011a1.315 1.315 0 00.031-.124l.005-.026a1.194 1.194 0 00.022-.131c0-.007.002-.014.003-.02l.002-.02.005-.053.003-.044a1.789 1.789 0 00.003-.057z"/></svg>',
        arrow_right: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.287 4.309a.93.93 0 011.384 0l5.756 6.2c.764.823.764 2.159 0 2.982l-5.756 6.2a.93.93 0 01-1.384 0 1.113 1.113 0 010-1.491l3.916-5.454a1.113 1.113 0 000-1.492L9.287 5.8a1.113 1.113 0 010-1.491z"/></svg>',
        arrow_two_ways_hor_l: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M7.232 12.303a1.036 1.036 0 111.465 1.465L7.464 15H19a1 1 0 010 2H7.464l1.233 1.232a1.036 1.036 0 11-1.465 1.465l-2.929-2.93a1.032 1.032 0 01-.301-.67L4 16.019V16l.001-.019v-.078c.013-.203.085-.404.216-.573l.086-.098zm9.536-8l2.929 2.93c.186.186.287.426.301.67v.064L20 8v.034l-.002.063a1.032 1.032 0 01-.301.67l-2.93 2.93a1.036 1.036 0 11-1.464-1.465L16.536 9H5a1 1 0 01-.993-.883L4 8a1 1 0 011-1h11.536l-1.233-1.232a1.036 1.036 0 111.465-1.465z"/></svg>',
        arrow_two_ways_hor_r: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M16.768 12.303a1.036 1.036 0 10-1.465 1.465L16.536 15H5a1 1 0 000 2h11.536l-1.233 1.232a1.036 1.036 0 101.465 1.465l2.929-2.93c.186-.186.287-.426.301-.67l.002-.078V16l-.001-.019v-.078a1.032 1.032 0 00-.216-.573l-.086-.098zm-9.536-8l-2.929 2.93a1.032 1.032 0 00-.301.67v.064L4 8v.034l.002.063c.014.244.115.484.301.67l2.93 2.93a1.036 1.036 0 101.464-1.465L7.464 9H19a1 1 0 00.993-.883L20 8a1 1 0 00-1-1H7.464l1.233-1.232a1.036 1.036 0 10-1.465-1.465z"/></svg>',
        arrow_two_ways_ver_b: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M11.697 16.768a1.036 1.036 0 10-1.465-1.465L9 16.536V5a1 1 0 00-2 0v11.536l-1.232-1.233a1.036 1.036 0 10-1.465 1.465l2.93 2.929c.186.186.426.287.67.301l.078.002H8l.019-.001h.078c.203-.013.404-.085.573-.216l.098-.086zm8-9.536l-2.93-2.929a1.032 1.032 0 00-.67-.301h-.064L16 4h-.034l-.063.002a1.032 1.032 0 00-.67.301l-2.93 2.93a1.036 1.036 0 101.465 1.464L15 7.464V19a1 1 0 00.883.993L16 20a1 1 0 001-1V7.464l1.232 1.233a1.036 1.036 0 101.465-1.465z"/></svg>',
        arrow_two_ways_ver_t: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M11.697 7.232a1.036 1.036 0 11-1.465 1.465L9 7.464V19a1 1 0 01-2 0V7.464L5.768 8.697a1.036 1.036 0 11-1.465-1.465l2.93-2.929c.186-.186.426-.287.67-.301L7.981 4H8l.019.001h.078c.203.013.404.085.573.216l.098.086zm8 9.536l-2.93 2.929a1.032 1.032 0 01-.67.301h-.064L16 20h-.034l-.063-.002a1.032 1.032 0 01-.67-.301l-2.93-2.93a1.036 1.036 0 111.465-1.464L15 16.536V5a1 1 0 01.883-.993L16 4a1 1 0 011 1v11.536l1.232-1.233a1.036 1.036 0 111.465 1.465z"/></svg>',
        arrow_up_alt: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12.067 4a2 2 0 01.059.004L12 4a2.026 2.026 0 01.527.07l.029.009a1.476 1.476 0 01.121.039l.01.004a2.006 2.006 0 01.405.202l.017.012 6 4a2 2 0 01-2.218 3.328L14 9.737 14 18a2 2 0 11-4 0V9.737l-2.89 1.927a2 2 0 01-2.22-3.328l6-4 .012-.008c.124-.081.257-.15.398-.202l.012-.004.11-.037.025-.008.011-.002a1.315 1.315 0 01.124-.031l.026-.005a1.194 1.194 0 01.131-.022c.007 0 .014-.002.02-.003l.02-.002.053-.005.044-.003A1.789 1.789 0 0111.933 4z"/></svg>',
        arrow_up: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M18.2 14.713l-5.454-3.916a1.113 1.113 0 00-1.492 0L5.8 14.713a1.113 1.113 0 01-1.491 0 .93.93 0 010-1.384l6.2-5.756c.823-.764 2.159-.764 2.982 0l6.2 5.756a.93.93 0 010 1.384 1.113 1.113 0 01-1.491 0z"/></svg>',
        barnd_pepperi: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M17.234 10.687a.17.17 0 00-.167-.171c-.446 0-.885.372-1.44.843-.887.753-1.99 1.69-3.705 1.69-1.714 0-2.818-.937-3.705-1.69-.556-.471-.994-.843-1.44-.843a.17.17 0 00-.168.171.17.17 0 00.167.172c.327 0 .744.354 1.228.765.88.747 2.084 2.563 3.918 2.563 2.19 0 2.682-1.514 3.918-2.563.483-.41.9-.765 1.227-.765a.17.17 0 00.167-.172M6.671 7.588c0 1.039.826 1.884 1.841 1.884 1.015 0 1.841-.845 1.841-1.884 0-1.038-.826-1.883-1.841-1.883-1.015 0-1.841.845-1.841 1.883m6.866 0c0 1.039.826 1.884 1.841 1.884 1.016 0 1.841-.845 1.841-1.884 0-1.038-.825-1.883-1.84-1.883-1.016 0-1.842.845-1.842 1.883m7.386 10.922a3.46 3.46 0 00-.778-.087c-1.144 0-2.125.544-2.52 1.311-.394-.767-1.375-1.31-2.519-1.31-.266 0-.526.028-.778.086.387-.651 1.12-1.154 2.01-1.405.12-.034.244-.063.37-.087V14.658a.188.188 0 00-.185-.19.188.188 0 00-.186.19v2.056c-.751.196-1.409.559-1.885 1.037-.802.11-1.655.185-2.507.185a18.55 18.55 0 01-2.507-.184c-.475-.479-1.133-.842-1.885-1.038v-2.056a.188.188 0 00-.185-.19.188.188 0 00-.186.19V17.018c.126.024.25.053.371.087.89.25 1.622.754 2.01 1.405a3.46 3.46 0 00-.779-.087c-1.144 0-2.124.544-2.52 1.311-.394-.767-1.374-1.31-2.519-1.31-.266 0-.526.028-.778.086.39-.656 1.13-1.16 2.028-1.409.088-.024.178-.046.27-.065V7.589c0-1.833 1.456-3.323 3.247-3.323 1.79 0 2.143.995 3.248 2.555.06.085.083.19.185.19.103 0 .127-.105.186-.19 1.139-1.647 1.457-2.555 3.247-2.555 1.791 0 3.248 1.49 3.248 3.322V17.035c.088.019.173.04.258.064.904.247 1.648.753 2.04 1.411M8.068 7.588c0 .25.198.454.443.454a.449.449 0 00.443-.454.449.449 0 00-.443-.453.449.449 0 00-.443.453m-.688 0c0-.638.507-1.157 1.131-1.157s1.13.52 1.13 1.157c0 .638-.506 1.157-1.13 1.157-.624 0-1.13-.519-1.13-1.157m7.553 0c0 .25.199.454.443.454a.449.449 0 00.444-.454.449.449 0 00-.444-.453.449.449 0 00-.443.453m-.687 0c0-.638.507-1.157 1.13-1.157.624 0 1.131.52 1.131 1.157 0 .638-.507 1.157-1.13 1.157-.624 0-1.131-.519-1.131-1.157m.48 10.416a2.626 2.626 0 00-.315.374.817.817 0 00.315-.374m4.918-1.172c-.04.045-.08.092-.12.135.695.287 1.287.708 1.71 1.222.26.015.515.044.764.088-.484-.62-1.321-1.123-2.354-1.445m-14.753-.088v-5.932c-.39-.236-.78-.368-1.135-.368-.145 0-.283.023-.41.07-1.047.385-1.14 2.298-.202 4.177.426.853 1.001 1.583 1.606 2.088l.141-.035m15.852-2.053c.938-1.879.845-3.792-.203-4.177a1.184 1.184 0 00-.41-.07c-.355 0-.744.132-1.135.368v5.932c.048.01.094.022.14.035.606-.505 1.182-1.235 1.608-2.088M2.819 18.035c-.278.015-.551.041-.819.08.5-.536 1.334-.98 2.365-1.283-.628.302-1.161.713-1.546 1.203"/></svg>',
        device_desktop: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M20 3a2 2 0 012 2v10a2 2 0 01-2 2h-7v2h4a1 1 0 010 2H7a1 1 0 010-2h4v-2H4a2 2 0 01-2-2V5a2 2 0 012-2h16zm-1 2H5a1 1 0 00-1 1v8a1 1 0 001 1h14a1 1 0 001-1V6a1 1 0 00-1-1z"/></svg>',
        device_mobile: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M16 3a2 2 0 012 2v14a2 2 0 01-2 2H8a2 2 0 01-2-2V5a2 2 0 012-2h8zm-1 2H9a1 1 0 00-1 1v12a1 1 0 001 1h6a1 1 0 001-1V6a1 1 0 00-1-1zm-1 11a1 1 0 010 2h-4a1 1 0 010-2h4z"/></svg>',
        device_tablet: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M18 2a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2h12zm0 16H6v1a1 1 0 00.883.993L7 20h10a1 1 0 001-1v-1zM17 4H7a1 1 0 00-1 1v11h12V5a1 1 0 00-.883-.993L17 4z"/></svg>',
        indicator_dot_placeholder: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8"><circle cx="4" cy="4" r="3.5" fill-rule="evenodd"/></svg>',
        misc_excel: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M15 4.18a1 1 0 01.993.884L16 5.18v13.64a1 1 0 01-1.048.998l-.116-.012-10-1.667a1 1 0 01-.829-.866L4 17.153V6.847a1 1 0 01.718-.96l.118-.026 10-1.667A1 1 0 0115 4.18zM19 7a1 1 0 011 1v8a1 1 0 01-1 1h-1a1 1 0 01-1-1V8a1 1 0 011-1zm-5.715.214l-2.078.224-1.243 2.976L8.769 7.7l-2.126.23 2.174 3.795L6.5 16.054l2.079.224 1.386-3.229 1.409 3.531 2.126.23-2.39-5.179 2.175-4.417z"/></svg>',
        no_image_2: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 200"><style>.placeholder{stroke:#999;stroke-width:4;stroke-linecap:round}</style><g fill="none" fill-rule="evenodd"><circle class="placeholder" cx="128" cy="60" r="32"/><path class="placeholder" d="M263 6H14a8 8 0 00-8 8v74M195.05 182.887L65.443 97.913a8 8 0 00-8.851.053L9.535 129.622A8 8 0 006 136.26V186a8 8 0 008 8h272a8 8 0 008-8v-84.869a8 8 0 00-3.368-6.523l-41.31-29.33a8 8 0 00-9.713.344l-90.374 74.339M294 85V63M294 45v-7.997M294 55.003v-2M294 29V14a8 8 0 00-8-8h-5M273 6h-2M6 122v-15.997m0-8v-2"/></g></svg>',
        ...
        shopping_cart: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M4 4h2.153a1 1 0 01.986.836L7.333 6H18a1 1 0 011 1v4.153a1 1 0 01-.836.986l-9.542 1.59.045.271H18a1 1 0 010 2H7.847a1 1 0 01-.986-.836L5.473 6.836A1 1 0 004.486 6H4a1 1 0 110-2zm3.86 5.164l.273 1.633a1 1 0 001.15.822l6.881-1.146A1 1 0 0017 9.486V9a1 1 0 00-1-1H8.847a1 1 0 00-.986 1.164zM17.5 20a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm-11 0a1.5 1.5 0 110-3 1.5 1.5 0 010 3z"/></svg>',
        shopping_paper: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 2a5 5 0 015 5v1h2a2 2 0 012 2v8a4 4 0 01-4 4H7a4 4 0 01-4-4v-8a2 2 0 012-2h2V7a5 5 0 015-5zm6 8H6a1 1 0 00-1 1v7a2 2 0 002 2h10a2 2 0 002-2v-7a1 1 0 00-1-1zm-6-6a3 3 0 00-3 3v1h6V7a3 3 0 00-3-3z"/></svg>',
        system_attach: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M10.86 14.378l2.787-2.786a.985.985 0 00-1.393-1.393l-2.786 2.786a2.955 2.955 0 104.179 4.18l2.786-2.787a4.925 4.925 0 00-6.965-6.965L6.68 10.199a.985.985 0 01-1.393-1.393L8.075 6.02a6.896 6.896 0 019.75 9.751l-2.785 2.786a4.925 4.925 0 01-6.965-6.965l2.786-2.786a2.955 2.955 0 114.179 4.18l-2.786 2.785a.985.985 0 01-1.393-1.393z"/></svg>',
        system_avatar: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M5.873 20C5.317 18.835 5 17.562 5 16.333c0-2.407 1.215-4.078 3.066-4.997C7.706 10.393 7.5 9.37 7.5 8.4 7.5 5.362 9.515 4 12 4s4.5 1.362 4.5 4.4c0 .97-.205 1.993-.566 2.936 1.85.919 3.066 2.59 3.066 4.997 0 1.23-.317 2.502-.873 3.667h-1.244c-1.16 0-1.16-.629-.999-.966.392-.816.616-1.705.616-2.534 0-1.482-.716-2.44-1.821-2.974C13.93 14.42 13.004 15 12 15c-1.004 0-1.93-.58-2.679-1.474C8.216 14.06 7.5 15.018 7.5 16.5c0 .827.223 1.712.612 2.525.163.34.163.975-.966.975H5.873zM12 12.5c1.105 0 2-2.2 2-3.857S13.105 6.5 12 6.5s-2 .486-2 2.143c0 1.657.895 3.857 2 3.857z"/></svg>',
        system_bin: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9 7V6a1 1 0 011-1h4a1 1 0 011 1v.999l.913.001H17a1 1 0 010 2h-.167l-.757 9.083a1 1 0 01-.996.917H8.92a1 1 0 01-.996-.917L7.166 9H7a1 1 0 110-2h2zm5.76 2l-5.525.005L9.79 17h4.42l.55-8z"/></svg>',
        system_bolt: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M10.612 19.84a.33.33 0 01-.279.16.332.332 0 01-.128-.026.362.362 0 01-.199-.402l1.25-6.568H7.333c-.103 0-.2-.05-.263-.137a.374.374 0 01-.06-.305l2-8.293A.336.336 0 019.333 4h6c.122 0 .235.07.294.185a.377.377 0 01-.012.362L12.943 9h3.723c.122 0 .235.064.294.18a.387.387 0 01-.015.37l-6.333 10.29z"/></svg>',
        system_chat: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M11.5 4a7.5 7.5 0 016.755 10.764L20 20l-5.236-1.745A7.5 7.5 0 1111.5 4zm0 2a5.5 5.5 0 102.392 10.454l.732-.354 2.214.738-.738-2.214.354-.732A5.5 5.5 0 0011.5 6zm-2 4a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm4 0a1.5 1.5 0 110 3 1.5 1.5 0 010-3z"/></svg>',
        system_circle: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="8" fill-rule="evenodd"/></svg>',
        ...
        system_doc: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M13.172 4a1 1 0 01.707.293l3.828 3.828a1 1 0 01.293.707V19a1 1 0 01-1 1H7a1 1 0 01-1-1V5a1 1 0 011-1h6.172zM11 6H9a1 1 0 00-1 1v10a1 1 0 001 1h6a1 1 0 001-1v-6a1 1 0 00-1-1h-2a1 1 0 01-1-1V7a1 1 0 00-1-1z"/></svg>',
        system_door: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M19 16.7a2 2 0 01-1.188 1.828l-7.109 3.16A.5.5 0 0110 21.23V10.3a2 2 0 011.188-1.828l5.579-2.48L7 5.959V17a1 1 0 01-2 0V5a1 1 0 011-1h12a1 1 0 011 1v11.7z"/></svg>',
        system_dot_ellipsis: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill-rule="evenodd" transform="translate(5 17)"><circle cx="1.5" cy="1.5" r="1.5"/><circle cx="7.5" cy="1.5" r="1.5"/><circle cx="13.5" cy="1.5" r="1.5"/></g></svg>',
        system_edit: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M21 20a1 1 0 010 2H3a1 1 0 010-2h18zM14.207 2.793l4 4a1 1 0 010 1.414l-8.5 8.5a1 1 0 01-.39.242l-6 2a1 1 0 01-1.266-1.265l2-6a1 1 0 01.242-.391l8.5-8.5a1 1 0 011.414 0zM11 7.414L5.874 12.54 4.581 16.42l3.879-1.293L13.585 10 11 7.414zm2.501-2.5L12.414 6 15 8.585 16.086 7.5 13.5 4.914z"/></svg>',
        system_education: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12.12 4.062l10.478 5.719a.25.25 0 010 .438l-.598.326V15a1 1 0 01-2 0v-3.363l-2 1.091V16c0 2.21-2.686 4-6 4s-6-1.79-6-4v-3.272L1.402 10.22a.25.25 0 010-.438L11.88 4.062a.25.25 0 01.24 0zm-4.121 9.757L8 16c0 .893 1.66 2 4 2s4-1.107 4-2l-.001-2.18-3.88 2.118a.25.25 0 01-.239 0L8 13.819zm3.98-7.302l-.038.013-6.237 3.36a.125.125 0 00-.031.196l.031.024 6.237 3.36a.125.125 0 00.08.013l.038-.013 6.237-3.36a.125.125 0 00.031-.196l-.031-.024-6.237-3.36a.125.125 0 00-.08-.013z"/></svg>',
        system_email: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 4c4.411 0 8 3.589 8 8 0 .543-.055 1.086-.163 1.612-.344 1.64-1.939 2.685-3.555 2.345a2.973 2.973 0 01-1.64-.955A3.984 3.984 0 0112 16c-2.206 0-4-1.794-4-4s1.794-4 4-4a4.004 4.004 0 013.923 4.782l-.008.033a.994.994 0 00.143.752.998.998 0 00.632.432 1.008 1.008 0 001.184-.775A6.006 6.006 0 0012 6C8.691 6 6 8.69 6 12a6.006 6.006 0 008.064 5.636 1 1 0 11.685 1.88 7.983 7.983 0 01-2.75.484L12 20c-4.411 0-8-3.589-8-8s3.589-8 8-8zm0 6c-1.103 0-2 .897-2 2s.897 2 2 2 2-.897 2-2-.897-2-2-2z"/></svg>',
        system_file_download: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M19 11a1 1 0 011 1v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4a1 1 0 012 0v3a1 1 0 001 1h10a1 1 0 001-1v-3a1 1 0 011-1zm-6-5v5h2.575a.5.5 0 01.312.89l-3.575 2.86a.5.5 0 01-.624 0l-3.575-2.86a.5.5 0 01.312-.89H11V6h2z"/></svg>',
        system_file_upload_cloud: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M10 6a4 4 0 013.6 2.253 4 4 0 015.397 3.917A3 3 0 0118 18h-5.001L13 14h2.575a.5.5 0 00.312-.89l-3.575-2.86a.5.5 0 00-.624 0l-3.575 2.86a.5.5 0 00.312.89H11l-.001 4H7a4 4 0 01-.997-7.875L6 10a4 4 0 014-4z"/></svg>',
        ...
        system_info: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 3a9 9 0 110 18 9 9 0 010-18zm0 2a7 7 0 100 14 7 7 0 000-14zm.32 6a1 1 0 01.986 1.164l-.667 4a1 1 0 01-.986.836h-.473a1 1 0 01-.986-1.164l.667-4a1 1 0 01.986-.836h.473zm.18-4a1.5 1.5 0 110 3 1.5 1.5 0 010-3z"/></svg>',
        system_inventory: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12.394 4.08l7.302 3.13a.5.5 0 01.303.46L20 16.33a.5.5 0 01-.303.46l-7.304 3.128a1 1 0 01-.787 0L4.303 16.79A.5.5 0 014 16.33V7.67c0-.2.119-.38.303-.459l7.303-3.13a1 1 0 01.788 0zM6 9.518v5.824l5 2.142V11.66L6 9.517zm12 0l-5 2.142v5.824l5-2.142V9.517zm-6-3.429L7.539 8 12 9.912 16.461 8 12 6.088z"/></svg>',
        system_link: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.254 10.627a.97.97 0 010 1.373L6.51 14.745a1.941 1.941 0 002.744 2.745L12 14.745a.97.97 0 111.373 1.372l-2.746 2.746a3.882 3.882 0 01-5.49-5.49l2.745-2.746a.97.97 0 011.372 0zm5.491-1.373a.972.972 0 010 1.373l-4.117 4.118a.97.97 0 01-1.373-1.373l4.118-4.118a.97.97 0 011.372 0zm4.118-4.117a3.882 3.882 0 010 5.49l-2.746 2.745A.97.97 0 1114.745 12l2.745-2.746a1.942 1.942 0 00-2.745-2.744L12 9.255a.97.97 0 01-1.373-1.373l2.746-2.745a3.883 3.883 0 015.49 0z"/></svg>',
        system_map: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M8.958 20l-.073-.006a.985.985 0 01-.14-.027l-.03-.008a.855.855 0 01-.08-.027l-.006-.004-5-2A1 1 0 013 17V5a1 1 0 011.371-.928l4.66 1.863 5.653-1.884.01-.003a.997.997 0 01.086-.024l-.096.027a1.024 1.024 0 01.206-.046l.03-.002a.85.85 0 01.086-.004H15.042a.984.984 0 01.213.034l.03.008a.855.855 0 01.08.027l.006.004 5 2A1 1 0 0121 7v12a1 1 0 01-1.371.928l-4.661-1.864-5.652 1.885-.01.003a.997.997 0 01-.086.024l.096-.027a1.024 1.024 0 01-.206.046l-.03.002a.85.85 0 01-.086.004H8.958zM14 6.387l-4 1.334v9.892l4-1.334V6.387zm-9 .09v9.846l3 1.2V7.677l-3-1.2zm11 0v9.846l3 1.2V7.677l-3-1.2z"/></svg>',
        system_menu_dots: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill-rule="evenodd" transform="translate(10 4)"><path d="M2 12a2 2 0 110 4 2 2 0 010-4zm0-6a2 2 0 110 4 2 2 0 010-4z"/><rect width="4" height="4" rx="2"/></g></svg>',
        system_menu: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M19 16a1 1 0 010 2H5a1 1 0 010-2h14zm0-5a1 1 0 010 2H5a1 1 0 010-2h14zm0-5a1 1 0 010 2H5a1 1 0 110-2h14z"/></svg>',
        system_move: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 14a1 1 0 011 1v3.585l1.293-1.292a1 1 0 011.32-.083l.094.083a1 1 0 010 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L11 18.585V15a1 1 0 011-1zM6.707 8.293a1 1 0 010 1.414L5.415 11 9 11a1 1 0 010 2l-3.587-.001 1.294 1.294a1 1 0 01-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm10.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414l1.292-1.294L15 13a1 1 0 010-2l3.585-.001-1.292-1.292a1 1 0 01-.083-1.32zm-6-6a1 1 0 011.414 0l3 3a1 1 0 11-1.414 1.414L13 5.414V9a1 1 0 01-2 0V5.414L9.707 6.707a1 1 0 01-1.32.083l-.094-.083a1 1 0 010-1.414z"/></svg>',
        ...
        system_off_line: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M20.142 5l1.414 1.414-2.93 2.93A4 4 0 0117 17h-6.03l-3.556 3.556L6 19.142 20.142 5zM14 5c1.141 0 2.17.478 2.9 1.244l-1.416 1.415a1.998 1.998 0 00-3.283.467l-.398.819a1 1 0 01-1.25.5l-.852-.32A1.991 1.991 0 009 9c-1.105 0-2 .895-2 1.98l.04 1.592-1.373.484A1.001 1.001 0 006 15h2.142l-2 2H6a3 3 0 01-.997-5.83l-.002-.085L5 11a4 4 0 015.402-3.748A3.998 3.998 0 0114 5zm3.029 5.941L12.97 15H17a2 2 0 00.5-3.937l-.471-.122z"/></svg>',
        system_ok: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M17.511 7c-.376.011-.732.168-.995.438-2.29 2.295-4.38 4.544-6.58 6.79l-2.584-2.072a1.445 1.445 0 00-2.035.226 1.448 1.448 0 00.226 2.035l3.618 2.894c.578.46 1.409.411 1.929-.113 2.602-2.608 4.934-5.17 7.476-7.718A1.449 1.449 0 0017.511 7z"/></svg>',
        system_pause: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M8.5 5A1.5 1.5 0 0110 6.5v11a1.5 1.5 0 01-3 0v-11A1.5 1.5 0 018.5 5zm7 0A1.5 1.5 0 0117 6.5v11a1.5 1.5 0 01-3 0v-11A1.5 1.5 0 0115.5 5z"/></svg>',
        system_phone: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M4.814 8.88c1.362-1.39 2.043-1.022 2.98.328.85 1.228.595 2.046 0 2.578-.384.327-1.363.9-.852 1.76.724 1.227 2.129 2.7 3.363 3.478.851.531 1.532-.369 1.915-.696.596-.573 1.447-.736 2.64.164 1.32.982 1.66 1.677.127 2.905C9.88 22.384 1.323 13.546 4.814 8.88zM11 4a9 9 0 019 9 1 1 0 01-2 0 7 7 0 00-7-7 1 1 0 010-2zm0 4a5 5 0 015 5 1 1 0 01-2 0 3 3 0 00-3-3 1 1 0 010-2z"/></svg>',
        system_play: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M8 4.869a1 1 0 01.555.167l9.821 6.548a.5.5 0 010 .832l-9.821 6.548A1 1 0 017 18.13V5.87a1 1 0 011-1zm2 4a1 1 0 00-1 1v4.262a1 1 0 001.555.833l3.821-2.548a.5.5 0 000-.832l-3.821-2.548A1 1 0 0010 8.87z"/></svg>',
        system_print: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M15 7a1 1 0 00-1-1h-4a1 1 0 00-.993.883L9 7v1H7V6a2 2 0 012-2h6a2 2 0 012 2v2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2v2a2 2 0 01-2 2H9a2 2 0 01-2-2v-2H5a2 2 0 01-2-2v-4a2 2 0 012-2h10V7zm0 7H9v3a1 1 0 00.883.993L10 18h4a1 1 0 00.993-.883L15 17v-3zm3-4H6a1 1 0 00-.993.883L5 11v2a1 1 0 00.883.993L6 14h1v-2h10v2h1a1 1 0 00.993-.883L19 13v-2a1 1 0 00-1-1z"/></svg>',
        system_processing: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 12a1 1 0 012 0 8 8 0 01-11.955 6.955l-1.338 1.338A1 1 0 015 19.586V16a1 1 0 011-1h3.586a1 1 0 01.707 1.707l-.763.763A6 6 0 0018 12zM4 12a8 8 0 0111.955-6.955l1.338-1.338A1 1 0 0119 4.414V8a1 1 0 01-1 1h-3.586a1 1 0 01-.707-1.707l.763-.763A6 6 0 006 12a1 1 0 01-2 0z" fill-rule="evenodd"/></svg>',
        system_question: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 3a9 9 0 110 18 9 9 0 010-18zm0 2a7 7 0 100 14 7 7 0 000-14zm-.004 9a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm-.087-7c2.565 0 3.814 1.075 3.814 2.575 0 .93-.665 1.713-1.25 2.022-.774.409-1.213.678-1.268 1.27l-.006.133h-2.703c0-1.421.199-1.866 1.118-2.285.782-.358 1.38-.656 1.38-1.14 0-.432-.493-.726-1.11-.726-.62 0-1.156.305-1.225.75l-.007.097H8.21C8.235 7.795 9.511 7 11.91 7z" fill-rule="evenodd"/></svg>',
        system_rotate_device: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M18.707 4.293A1 1 0 0119 5v3.586a1 1 0 01-1 1h-3.586a1 1 0 01-.707-1.707l.763-.763A6 6 0 006 12.561V16.5A1.5 1.5 0 007.5 18h9a1.5 1.5 0 001.5-1.5V13a1 1 0 012 0v4a3 3 0 01-3 3H7a3 3 0 01-3-3v-5h.021a8 8 0 0111.934-6.37l1.338-1.337a1 1 0 011.414 0zM12 11a2 2 0 011.001 3.732L13 16a1 1 0 01-2 0v-1.268A2 2 0 0112 11z"/></svg>',
        system_search: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M10.5 4a6.5 6.5 0 015.533 9.912l3.538 3.538a1 1 0 010 1.414l-.707.707a1 1 0 01-1.414 0l-3.538-3.538A6.5 6.5 0 1110.5 4zm0 2.5a4 4 0 100 8 4 4 0 000-8z"/></svg>',
        system_select: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M16.153 4l-1.944 2H6a1 1 0 00-1 1v11h14v-7.039c.66-.69 1.322-1.38 2-2.073V19a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1h12.153zm3.358 0a1.447 1.447 0 011.055 2.48c-2.542 2.548-4.874 5.11-7.476 7.718-.52.524-1.351.572-1.93.113l-3.617-2.894a1.449 1.449 0 011.809-2.261l2.585 2.072c2.199-2.246 4.29-4.495 6.58-6.79.262-.27.618-.427.994-.437z"/></svg>',
        system_settings: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M13 4l.691 2.765c.479.154.929.373 1.34.645l2.576-1.198 1.258 1.554-1.72 2.285c.175.463.29.954.334 1.466l2.543 1.299-.45 1.948-2.847.053a5.524 5.524 0 01-.926 1.16l.589 2.784-1.798.876-1.838-2.188a5.55 5.55 0 01-1.503 0l-1.84 2.188-1.797-.876.59-2.784a5.524 5.524 0 01-.927-1.16l-2.847-.053-.45-1.948 2.543-1.298a5.47 5.47 0 01.333-1.465l-1.72-2.287 1.26-1.554L8.967 7.41a5.477 5.477 0 011.342-.645L11 4h2zm-1 4.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z"/></svg>',
        system_signature: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M14.016 4.598l.235.002c1.196.047.94 1.048.557 1.43-1.459 1.387-3.133 2.392-4.927 3.205-.286.288-.573.574-.837.861-.365.385-1.198 1.591-2.065 2.904H20a1 1 0 010 2l-14.321.001c-.72 1.126-1.285 2.036-1.366 2.19-.383.669-1.62-.169-1.238-.838.038-.069.361-.616.807-1.359A1.002 1.002 0 014 13h1.095c.724-1.173 1.44-2.291 1.758-2.67-1.172.407-1.922.676-3.117 1.01-.742.215-1.137-1.291-.395-1.506 1.937-.55 3.922-1.125 5.764-1.938.717-.67 1.393-1.499 2.158-2.072.884-.694 1.793-1.272 2.988-1.224zm-1.648 4.278c.478-.192.933.478.67.885-.12.143-.192.31-.241.479.814-.096 1.507-.359 2.224-.862.263-.191.669-.048.813.215.12.215 1.507-.358 1.698-.43.336-.12.647.12.742.406.023.095.048.167.048.24.67.023 1.482-.192 2.104-.264.765-.096.762 1.453-.003 1.549-.886.096-1.89.335-2.775.191-.191-.048-.334-.215-.406-.406-.693.239-1.458.478-2.008.12-.981.574-2.057.836-3.229.789-.43-.024-.621-.382-.573-.765 0-.048.024-.072.024-.12-.598.262-1.173.574-1.746.885-.67.382-1.265-.999-.595-1.382a23.77 23.77 0 013.253-1.53z"/></svg>',
        system_spinner: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11 15a2 2 0 110 4 2 2 0 010-4zm5.5-1a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm-9-5a2.5 2.5 0 110 5 2.5 2.5 0 010-5zm10 0a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm-5-5a2.5 2.5 0 110 5 2.5 2.5 0 010-5z" fill-rule="evenodd"/></svg>',
        system_support: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M17 16V8l-.005-.182C16.875 5.76 14.743 4 12 4 9.176 4 7 5.865 7 8v8H5a2 2 0 01-2-2v-4a2 2 0 012-2l.004-.215C5.137 4.57 8.218 2 12 2c3.866 0 7 2.686 7 6a2 2 0 012 2v4a2 2 0 01-2 2c0 2.311-2.196 4.257-5.179 4.83A2.001 2.001 0 0110 20a2 2 0 013.622-1.17C15.641 18.396 17 17.188 17 16z"/></svg>',
        system_texterea: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M19.74 16.112a.889.889 0 010 1.257l-2.37 2.37a.889.889 0 11-1.258-1.256l2.37-2.37a.889.889 0 011.258 0zm0-5.926a.889.889 0 010 1.257l-8.297 8.297a.889.889 0 11-1.257-1.257l8.297-8.297a.889.889 0 011.257 0zm0-5.926a.889.889 0 010 1.257L5.517 19.74a.889.889 0 01-1.257-1.257L18.483 4.26a.889.889 0 011.257 0z"/></svg>',
        system_tool: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M17.5 3.293a1 1 0 01.083 1.32l-.083.094-1.06 1.06a1.5 1.5 0 002.12 2.122l1.061-1.06.088-.078a1 1 0 011.41 1.397l-.083.095-1.061 1.06a3.502 3.502 0 01-4.14.606l-5.255 5.255a3.5 3.5 0 11-1.416-1.416l5.256-5.254a3.502 3.502 0 01.605-4.14l1.06-1.061.088-.078a1 1 0 011.327.078zm-10 12.035a1.5 1.5 0 100 3 1.5 1.5 0 000-3z"/></svg>',
        ...
        text_align_center: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15 17a1 1 0 010 2H9a1 1 0 010-2zm6-4a1 1 0 010 2H3a1 1 0 010-2zm-2-4a1 1 0 010 2H5a1 1 0 010-2zm3-4a1 1 0 010 2H2a1 1 0 110-2z" fill-rule="evenodd"/></svg>',
        text_align_left: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M22 17a1 1 0 010 2h-6a1 1 0 010-2zm0-4a1 1 0 010 2H4a1 1 0 010-2zm0-4a1 1 0 010 2H8a1 1 0 010-2zm0-4a1 1 0 010 2H2a1 1 0 110-2z" fill-rule="evenodd"/></svg>',
        text_align_right: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M8 17a1 1 0 010 2H2a1 1 0 010-2zm12-4a1 1 0 010 2H2a1 1 0 010-2zm-4-4a1 1 0 010 2H2a1 1 0 010-2zm6-4a1 1 0 010 2H2a1 1 0 110-2z" fill-rule="evenodd"/></svg>',
        ...
        view_line: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M18 13a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2a2 2 0 012-2h12zm-1 2H7a1 1 0 00-.117 1.993L7 17h10a1 1 0 000-2zm1-10a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h12zm-1 2H7a1 1 0 00-.117 1.993L7 9h10a1 1 0 000-2z"/></svg>',
        view_matrix: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M21 19a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v14zM5 16v2a1 1 0 00.883.993L6 19h2v-3H5zm9 0h-4v3h4v-3zm5 0h-3v3h2a1 1 0 00.993-.883L19 18v-2zm-5-6h-4v4h4v-4zm5 0h-3v4h3v-4zm-5-5h-4v3h4V5zm4 0h-2v3h3V6a1 1 0 00-1-1zM8 5H6a1 1 0 00-.993.883L5 6v2h3V5zm-3 9h3v-4H5v4z"/></svg>',
        view_table: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M18 5a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h12zm0 10H6v1a1 1 0 00.883.993L7 17h10a1 1 0 001-1v-1zm0-4H6v2h12v-2zm-1-4H7a1 1 0 00-1 1v1h12V8a1 1 0 00-.883-.993L17 7z"/></svg>'
    };

    /* 🤖 this file was generated by svg-to-ts*/
    var pepIconArrowBackLeft = {
        name: 'arrow_back_left',
        data: "<svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M19.713 4.309c.383.412.383 1.08 0 1.491l-3.916 5.454a1.113 1.113 0 000 1.492l3.916 5.454c.383.412.383 1.08 0 1.491a.93.93 0 01-1.384 0l-5.756-6.2c-.764-.823-.764-2.159 0-2.982l5.756-6.2a.93.93 0 011.384 0zm-7 0c.383.412.383 1.08 0 1.491l-3.916 5.454a1.113 1.113 0 000 1.492l3.916 5.454c.383.412.383 1.08 0 1.491a.93.93 0 01-1.384 0l-5.756-6.2c-.764-.823-.764-2.159 0-2.982l5.756-6.2a.93.93 0 011.384 0z\" fill-rule=\"evenodd\"/></svg>"
    };
    var pepIconArrowBackRight = {
    ...
    var pepIconIndicatorDotPlaceholder = {
    ...
    var pepIconSystemFileUploadCloud = {
    ...
    var pepIconTimeDatetime = {
        name: 'time_datetime',
        data: "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill-rule=\"evenodd\" d=\"M16 3a1 1 0 011 1v1h1a2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h1V4a1 1 0 01.883-.993L8 3a1 1 0 011 1v1h2V4a1 1 0 01.883-.993L12 3a1 1 0 011 1v1h2V4a1 1 0 01.883-.993zm1 4H7a1 1 0 00-1 1v9a1 1 0 001 1h10a1 1 0 001-1V8a1 1 0 00-1-1zm-5 1a1 1 0 011 1v3.585l1.828 1.83a1 1 0 11-1.414 1.413l-2.121-2.12-.073-.083a1.003 1.003 0 01-.007-.008l.08.09A1.008 1.008 0 0111 13.02 1 1 0 0111 13V9a1 1 0 011-1z\"/></svg>"
    };
    var pepIconTimeDuration = {
        name: 'time_duration',
        data: "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill-rule=\"evenodd\" d=\"M16 3a1 1 0 011 1v1h1a2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h1V4a1 1 0 01.883-.993L8 3a1 1 0 011 1v1h2V4a1 1 0 01.883-.993L12 3a1 1 0 011 1v1h2V4a1 1 0 01.883-.993zM7.983 7H7a1 1 0 00-1 1v9a1 1 0 001 1h10a1 1 0 001-1V8a1 1 0 00-1-1l-.983-.001L16 7h-.017l-3.966-.001L12 7h-.017l-3.966-.001L8 7h-.017zm3.724 1.793l2.829 2.828a.998.998 0 01.289.793.998.998 0 01-.29.793l-2.828 2.829a1 1 0 01-1.414-1.415l2.206-2.207-2.206-2.207a1 1 0 011.414-1.414z\"/></svg>"
    };
    var pepIconTimeTime = {
    ...
    var PepIconRegistry = /** @class */ (function () {
        function PepIconRegistry() {
            this.registry = new Map();
        }
        PepIconRegistry.prototype.registerIcons = function (icons) {
            var _this = this;
            icons.forEach(function (icon) { return _this.registry.set(icon.name, icon.data); });
        };
        PepIconRegistry.prototype.getIcon = function (iconName) {
            if (!this.registry.has(iconName)) {
                console.warn("We could not find the Icon with the name " + iconName + ",\n                did you add it to the Icon registry?");
            }
            return this.registry.get(iconName);
        };
        return PepIconRegistry;
    }());
    PepIconRegistry.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PepIconRegistry_Factory() { return new PepIconRegistry(); }, token: PepIconRegistry, providedIn: "platform" });
    ...
    var PepIconComponent = /** @class */ (function () {
        function PepIconComponent(renderer, element, utilitiesService, colorService, iconRegistry, document) {
        ...
        Object.defineProperty(PepIconComponent.prototype, "spin", {
            /**
             * If icon spin
             *
        ...
        Object.defineProperty(PepIconComponent.prototype, "name", {
            /**
        ...
        Object.defineProperty(PepIconComponent.prototype, "fill", {
            /**
         ...
         * @memberof PepIconComponent
         */
        PepIconComponent.prototype.setFill = function () {
            if (this.svgIcon && this._fill) {
                var colorProperty = this.svgIcon.classList.contains('stroke')
                    ? 'stroke'
                    : 'fill';
         ...
         * @memberof PepIconComponent
         */
        PepIconComponent.prototype.setSpin = function () {
            if (this.svgIcon) {
                if (this._spin) {
    ...
    PepIconComponent.ctorParameters = function () { return [
        { type: i0.Renderer2 },
        { type: i0.ElementRef },
    ...
    var PepIconModule = /** @class */ (function () {
        function PepIconModule() {
        }
        return PepIconModule;
    }());
    PepIconModule.decorators = [
    ...
    exports.PepIconComponent = PepIconComponent;
    exports.PepIconModule = PepIconModule;
    exports.PepIconRegistry = PepIconRegistry;
    exports.allIcons = allIcons;
    exports.pepIconArrowBack = pepIconArrowBack;
    exports.pepIconArrowBackLeft = pepIconArrowBackLeft;
    exports.pepIconArrowBackRight = pepIconArrowBackRight;
    exports.pepIconArrowDown = pepIconArrowDown;
    exports.pepIconArrowDownAlt = pepIconArrowDownAlt;
    exports.pepIconArrowEither = pepIconArrowEither;
    exports.pepIconArrowLeft = pepIconArrowLeft;
    exports.pepIconArrowLeftAlt = pepIconArrowLeftAlt;
    exports.pepIconArrowRight = pepIconArrowRight;
    exports.pepIconArrowRightAlt = pepIconArrowRightAlt;
    exports.pepIconArrowTwoWaysHorL = pepIconArrowTwoWaysHorL;
    exports.pepIconArrowTwoWaysHorR = pepIconArrowTwoWaysHorR;
    exports.pepIconArrowTwoWaysVerB = pepIconArrowTwoWaysVerB;
    exports.pepIconArrowTwoWaysVerT = pepIconArrowTwoWaysVerT;
    exports.pepIconArrowUp = pepIconArrowUp;
    exports.pepIconArrowUpAlt = pepIconArrowUpAlt;
    exports.pepIconBarndPepperi = pepIconBarndPepperi;
    exports.pepIconDeviceDesktop = pepIconDeviceDesktop;
    exports.pepIconDeviceMobile = pepIconDeviceMobile;
    exports.pepIconDeviceTablet = pepIconDeviceTablet;
    exports.pepIconIndicatorDotPlaceholder = pepIconIndicatorDotPlaceholder;
    exports.pepIconMiscExcel = pepIconMiscExcel;
    exports.pepIconNoImage = pepIconNoImage;
    exports.pepIconNoImage2 = pepIconNoImage2;
    exports.pepIconNumberCoins = pepIconNumberCoins;
    exports.pepIconNumberDecimal = pepIconNumberDecimal;
    exports.pepIconNumberDollar = pepIconNumberDollar;
    exports.pepIconNumberEuro = pepIconNumberEuro;
    exports.pepIconNumberMinus = pepIconNumberMinus;
    exports.pepIconNumberNumber = pepIconNumberNumber;
    exports.pepIconNumberPercent = pepIconNumberPercent;
    exports.pepIconNumberPlus = pepIconNumberPlus;
    exports.pepIconRipplesTransparent = pepIconRipplesTransparent;
    exports.pepIconShoppingCart = pepIconShoppingCart;
    exports.pepIconShoppingPaper = pepIconShoppingPaper;
    exports.pepIconSystemAttach = pepIconSystemAttach;
    exports.pepIconSystemAvatar = pepIconSystemAvatar;
    exports.pepIconSystemBin = pepIconSystemBin;
    exports.pepIconSystemBolt = pepIconSystemBolt;
    exports.pepIconSystemChat = pepIconSystemChat;
    exports.pepIconSystemCircle = pepIconSystemCircle;
    exports.pepIconSystemClose = pepIconSystemClose;
    exports.pepIconSystemDoc = pepIconSystemDoc;
    exports.pepIconSystemDoor = pepIconSystemDoor;
    exports.pepIconSystemDotEllipsis = pepIconSystemDotEllipsis;
    exports.pepIconSystemEdit = pepIconSystemEdit;
    exports.pepIconSystemEducation = pepIconSystemEducation;
    exports.pepIconSystemEmail = pepIconSystemEmail;
    exports.pepIconSystemFileDownload = pepIconSystemFileDownload;
    exports.pepIconSystemFileUpload = pepIconSystemFileUpload;
    exports.pepIconSystemFileUploadCloud = pepIconSystemFileUploadCloud;
    exports.pepIconSystemFilter = pepIconSystemFilter;
    exports.pepIconSystemFilter2 = pepIconSystemFilter2;
    exports.pepIconSystemFullScreen = pepIconSystemFullScreen;
    exports.pepIconSystemHeart = pepIconSystemHeart;
    exports.pepIconSystemHome = pepIconSystemHome;
    exports.pepIconSystemInfo = pepIconSystemInfo;
    exports.pepIconSystemInventory = pepIconSystemInventory;
    exports.pepIconSystemLink = pepIconSystemLink;
    exports.pepIconSystemMap = pepIconSystemMap;
    exports.pepIconSystemMenu = pepIconSystemMenu;
    exports.pepIconSystemMenuDots = pepIconSystemMenuDots;
    exports.pepIconSystemMove = pepIconSystemMove;
    exports.pepIconSystemMust = pepIconSystemMust;
    exports.pepIconSystemOffLine = pepIconSystemOffLine;
    exports.pepIconSystemOk = pepIconSystemOk;
    exports.pepIconSystemPause = pepIconSystemPause;
    exports.pepIconSystemPhone = pepIconSystemPhone;
    exports.pepIconSystemPlay = pepIconSystemPlay;
    exports.pepIconSystemPrint = pepIconSystemPrint;
    exports.pepIconSystemProcessing = pepIconSystemProcessing;
    exports.pepIconSystemQuestion = pepIconSystemQuestion;
    exports.pepIconSystemRotateDevice = pepIconSystemRotateDevice;
    exports.pepIconSystemSearch = pepIconSystemSearch;
    exports.pepIconSystemSelect = pepIconSystemSelect;
    exports.pepIconSystemSettings = pepIconSystemSettings;
    exports.pepIconSystemSignature = pepIconSystemSignature;
    exports.pepIconSystemSpinner = pepIconSystemSpinner;
    exports.pepIconSystemSupport = pepIconSystemSupport;
    exports.pepIconSystemTexterea = pepIconSystemTexterea;
    exports.pepIconSystemTool = pepIconSystemTool;
    exports.pepIconSystemView = pepIconSystemView;
    exports.pepIconTextAlignCenter = pepIconTextAlignCenter;
    exports.pepIconTextAlignLeft = pepIconTextAlignLeft;
    exports.pepIconTextAlignRight = pepIconTextAlignRight;
    exports.pepIconTimeCal = pepIconTimeCal;
    exports.pepIconTimeDatetime = pepIconTimeDatetime;
    exports.pepIconTimeDuration = pepIconTimeDuration;
    exports.pepIconTimeTime = pepIconTimeTime;
    exports.pepIconViewCardLg = pepIconViewCardLg;
    exports.pepIconViewCardMd = pepIconViewCardMd;
    exports.pepIconViewCardSm = pepIconViewCardSm;
    exports.pepIconViewLine = pepIconViewLine;
    exports.pepIconViewMatrix = pepIconViewMatrix;
    exports.pepIconViewTable = pepIconViewTable;
