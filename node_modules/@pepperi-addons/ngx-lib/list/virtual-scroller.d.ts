...
export declare type ScrollDirectionType = 'backward' | 'forward';
...
export declare class VirtualScrollerComponent implements OnInit, OnChanges, OnDestroy {
    ...
    private _lastChildRect;
    vsChildRectChange: EventEmitter<ClientRect>;
    ...
    constructor(element: ElementRef, renderer: Renderer2, zone: NgZone, changeDetectorRef: ChangeDetectorRef, platformId: any, options: VirtualScrollerDefaultOptions);
    ...
    protected debounce(func: () => void, wait: number, ...args: any[]): () => void;
    protected throttleTrailing(func: () => void, wait: number, ...args: any[]): () => void;
